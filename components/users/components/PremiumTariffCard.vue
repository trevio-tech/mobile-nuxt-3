<template>
  <div class="w-[200px] h-[320px] p-4 rounded-lg flex flex-col shadow-sm border border-sky-200 bg-gradient-to-r from-sky-200 to-indigo-200 hover:shadow-md transition-shadow">
