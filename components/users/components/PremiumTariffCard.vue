<template>
  <div class="w-[200px] h-[280px] p-2 rounded-lg flex flex-col shadow-sm border border-sky-200 bg-gradient-to-r from-sky-200 to-indigo-200 hover:shadow-md transition-shadow">
...
<script setup>
import PremiumTariffBuyConfirmDialog from '~/components/users/components/PremiumTariffBuyConfirmDialog.vue'
